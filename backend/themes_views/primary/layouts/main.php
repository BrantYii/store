...
//echo "<BR><BR><BR>".Yii::$app->theme->baseUrl;
$theme_url = Yii::$app->view->theme->baseUrl;
//echo "<BR><BR><BR>".Yii::$app->view->theme->baseUrl;
//var_dump(Yii::$app);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<div id="wrapper">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="index.html">
                        ...
                        <img src="<?php echo $theme_url.'/img/flex-admin-logo.png'?>" data-1x="<?php echo $theme_url.'img/flex-admin-logo@1x.png'?>" data-2x="<?php echo $theme_url.'img/flex-admin-logo@2x.png'?>" class="hisrc img-responsive" alt="">
                    </a>
                </div>
            </div>
            <!-- end BRAND HEADING -->
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo $theme_url.'/img/user-profile-1.jpg'?>" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo $theme_url.'/img/user-profile-2.jpg'?>" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo $theme_url.'/img/user-profile-3.jpg'?>" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo $theme_url.'/img/user-profile-4.jpg'?>" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
            ...
            <div class="navbar-collapse sidebar-collapse collapse">
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="side-user hidden-xs">
                        <img class="img-circle" src="<?php echo $theme_url.'/img/profile-pic.jpg'?>" alt="">
                        <p class="welcome">
                            <i class="fa fa-key"></i> Logged in as
                        </p>
                        <p class="name tooltip-sidebar-logout">
                            John<?php // Yii::$app->user->identity->username ?>
                    ...
                    $panel = [
                            [
                            'heading'=>Yii::t('app', 'Catalogue'),
                            'id'=>'catalogue',
                            'icon'=>'glyphicon glyphicon-book',
                            'items'=>[
                                ['value'=>Yii::t('app', 'Products'),'url'=>Yii::$app->urlManager->createUrl('products'),'cid'=>'products'],
                                ['value'=>Yii::t('app', 'Categories'),'url'=>Yii::$app->urlManager->createUrl('categories'),'cid'=>'categories']
                            ],
                        ],
                            [
                            'heading'=>Yii::t('app', 'Localization'),
                            'id'=>'localization',
                            'icon'=>'glyphicon glyphicon-globe',
                            'items'=>[
                                ['value'=>Yii::t('app', 'Languages'),'url'=>Yii::$app->urlManager->createUrl('languages'),'cid'=>'languages'],
                                ['value'=>Yii::t('app', 'Currency'),'url'=>Yii::$app->urlManager->createUrl('currency'),'cid'=>'currency']
                            ],
                        ],                       
                            [
                            'heading'=>Yii::t('app', 'Administration'),
                            'id'=>'administration',
                            'icon'=>'glyphicon glyphicon-cog',
                            'items'=>[
                                ['value'=>Yii::t('app', 'Backend Users'),'url'=>Yii::$app->urlManager->createUrl('backenduser'),'cid'=>'backenduser'],                                
                                ['value'=>Yii::t('app', 'Backend Roles'),'url'=>Yii::$app->urlManager->createUrl('backendroles'),'cid'=>'backendroles'],                                
                                ['value'=>Yii::t('app', 'Backend Permissions'),'url'=>Yii::$app->urlManager->createUrl('backendactionroles'),'cid'=>'backendactionroles'],                                                                
                                ['value'=>Yii::t('app', 'Backend Controllers'),'url'=>Yii::$app->urlManager->createUrl('backendcontroller'),'cid'=>'backendcontroller'],                                                                                                
                            ],
                        ]                                               
                    ];
                    foreach($panel as $panelarr):
                    ?>
                    
                    <li class="panel">
                        <a href="javascript:;" data-parent="#side" data-toggle="collapse" class="accordion-toggle" data-target="#<?=$panelarr['id']?>">
                            <i class="<?= $panelarr['icon']?>"></i><span class="marginleft"><?= $panelarr['heading']?></span><i class="fa fa-caret-down"></i>
                        </a>
                        <ul class="collapse nav" id="<?=$panelarr['id']?>">
                            <?php if(isset($panelarr['items'])):
                                foreach ($panelarr['items'] as $itemsarr):
                                if($panelarr['items'] == Yii::$app->controller->id):
                                    $active = 1;
                                endif;
                                ?>
                            <li>
                                <a href="<?= $itemsarr['url']?>">
                                    <i class="fa fa-angle-double-right"></i> <?= $itemsarr['value']?>
                                </a>
                            </li>                                    
                            <?php    endforeach;
                            endif;
                    ...
                    <li class="panel">
                        ...
                        <ul class="collapse nav" id="charts" class="active">
                            <li>
                                <a href="flot.html">
                            ...
                            <li>
                                <a class="active" href="morris.html">
	...
	<?=Breadcrumbs::widget([
		'links' => isset($this->params['breadcrumbs']) ? $this->params['breadcrumbs'] : [],
                ...
                //'homeLink'=>['label'=> Html::tag('span','Dashboard',['class'=>'glyphicon glyphicon-circle-arrow-left']),'url'=>  Yii::$app->homeUrl],
                //'itemTemplate'=>'<i class="fa fa-dashboard"></i> <li>{link}</li>'
        	]); ?>                
            <?= $content ?>
            </div>
            <!-- /.page-content -->
    ...
    <div id="logout">
        <div class="logout-message">
            <img class="img-circle img-logout" src="<?php echo $theme_url.'/img/profile-pic.jpg'?>" alt="">
            <h3>
            ...
            <ul class="list-inline">
                <li>
                    ...
                    <?= Html::a('Logout', Yii::$app->urlManager->createUrl('site/logout'),['data-method'=>'post'])?>
