...
$this->title = $model->backend_controller_id;
...
<div class="half-div">
    ...
    <div class="caption-heading">
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->backend_controller_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->backend_controller_id], [
